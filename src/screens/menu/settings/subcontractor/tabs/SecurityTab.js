...
const RuleRow = ({ label, passed, colors }) => (
  <View style={styles.ruleRow}>
    <View style={[styles.ruleDot, { backgroundColor: passed ? colors.success : colors.border }]} />
...
const SecurityTab = ({ updateProfile, updatingProfile }) => {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      const formData = buildSubcontractorProfileFormData({ password: form.newPw });
