...
const StatusPill = ({status}) => (
  <View
    style={[
      styles.pill,
      {backgroundColor: STATUS_COLORS[status] ?? '#F97316'},
    ]}>
...
const FinancialScreen = ({navigation}) => {
  ...
  const {financialSummary, loading, getFinancialSummary} =
    useCompanyFinancials();
  const {allInvoices, loadingAll, allError, getCompanyInvoices} =
    useCompanyInvoices();
              ...
              <View style={styles.statsRow}>
                ...
                <View style={styles.statCell}>
                  <StatCard
                    ...
                    value={
                      activeProjects != null ? String(activeProjects) : '—'
                    }
                    icon={Briefcase}
                    iconColor="#10375C"
                    positive={true}
              ...
              <View style={[styles.statsRow, {marginTop: 10}]}>
                <View style={styles.statCell}>
                  <StatCard
                    ...
                    value={
                      onTimeCompletion != null ? `${onTimeCompletion}%` : '—'
                    }
                    icon={Clock}
                    iconColor="#10375C"
                    positive={true}
          ...
          {loadingAll && invoices.length === 0 ? (
            ...
            visibleInvoices.map((inv, idx) => (
              <View
                ...
                style={[
                  styles.invoiceRow,
                  idx !== visibleInvoices.length - 1 && styles.rowDivider,
                ]}>
